...
A ready-to-run GitHub Actions workflow is included at [`.github/workflows/digest.yml`](file:///.github/workflows/digest.yml). It automatically runs on a schedule daily at 03:30 UTC (9:00 AM IST).
...
A [`render.yaml`](file:///render.yaml) configuration is provided for one-click deployment as a managed Cron Job or Blueprint.
